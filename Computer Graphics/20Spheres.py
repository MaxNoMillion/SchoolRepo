# Defines 20 spheres that incorperates gourand and phong shading #
...
# Calculate a 3-D reflection vector, R, given surface normal, N, and lighting vectors, L
def reflect(N, L):
  R = []
  N = normalize(N)
  L = normalize(L)
...
# Converts an N dimensional vector into a unit vector (i.e., normalize the vector)
